...

{
  ...
  class RemoteContextHelper {
    /**
     * @param {RemoteContextConfig|object} remoteContextConfig The configuration
     *     for this remote context.
     */
    constructor(remoteContextConfig = DEFAULT_CONTEXT_CONFIG) {
      this.remoteContextConfig =
          RemoteContextConfig.ensure(remoteContextConfig);
    }
     ...
     * @param {RemoteContextConfig|object} extraRemoteContextConfig Will be
     ...
     * @returns {RemoteContextWrapper}
     */
    async addWindow(extraRemoteContextConfig = null, options = {
      target: null,
      features: null,
    }) {
  ...
  class RemoteContextWrapper {
     ...
     */
    async addIframe(extraRemoteContextConfig = null, options = {
      attributes: {},
    }) {
      return this.helper.createContext({
        executorCreator:
            await elementExecutorCreator(this, 'iframe', options.attributes),
        extraRemoteContextConfig: extraRemoteContextConfig,
      });
    }
     ...
     * @returns {RemoteContextWrapper} The remote context.
     */
    async addWorker(extraRemoteContextConfig = null) {
      return this.helper.createContext({
